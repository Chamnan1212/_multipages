    ...
    return (
        <div id="container">
            ...
            <div id="contrtol">
                ...
                <button id="humanballBtn" className="btn btn-primary" onClick={() => changeBallImage('./human.png')}>HUMAN</button>
                <button id="cartoonballBtn" className="btn btn-primary" onClick={() => changeBallImage('./cartoon.png')}>CARTOON</button>
