    ...
    <div className='CC'>
      <div className="calculator">
        ...
        <div className="buttons">
          {['C', '+/-', '%', '/'].map((symbol) => (
            <button key={symbol} onClick={() => handleButtonClick(symbol)} className={['C', '+/-', '%'].includes(symbol) ? 'gray' : 'green'}>
            {symbol}
            </button>
          ...
          {['0', '.', '='].map((symbol) => (
            <button key={symbol} onClick={() => handleButtonClick(symbol)} className={symbol === '0' ? 'zero gray' : symbol === '=' ? 'green' : 'gray'}>
              {symbol}
            </button>
          ))}
        </div>
